"""MySQL-compatible models (JSON instead of JSONB)."""
...
__all__ = [
    "Base", "User", "Course", "CourseMember", "CourseLesson", "TeacherLesson",
    "Homework", "Question", "Submission", "CourseResource", "StudentCategory",
    "StudentResource", "LearningProgress", "Notification", "AuditLog",
    "QuestionBank", "TutorProfile", "Paper", "PaperChunk", "ResearchResult",
