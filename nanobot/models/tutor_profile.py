...
class TutorProfile(Base):
    ...
    knowledge_points: Mapped[dict | None] = mapped_column(JSONB, nullable=True, default=list)
    error_records: Mapped[dict | None] = mapped_column(JSONB, nullable=True, default=list)
    strategies: Mapped[dict | None] = mapped_column(JSONB, nullable=True, default=list)
    total_submissions: Mapped[int] = mapped_column(Integer, default=0)
    last_active: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
    recommended_questions: Mapped[dict | None] = mapped_column(JSONB, nullable=True, default=list)
