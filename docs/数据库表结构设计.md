...
- [5. 课时表 (lessons)](#5-课时表-lessons)
- [6. 作业表 (homework)](#6-作业表-homework)
- [7. 题目表 (questions)](#7-题目表-questions)
- [8. 提交表 (submissions)](#8-提交表-submissions)
- [9. 课程资源表 (course_resources)](#9-课程资源表-course_resources)
- [10. 学习进度表 (learning_progress)](#10-学习进度表-learning_progress)
- [11. 通知表 (notifications)](#11-通知表-notifications)
- [12. 审计日志表 (audit_logs)](#12-审计日志表-audit_logs)
- [13. 完整建表脚本](#13-完整建表脚本)
...
| 4 | lessons | 课时表 | 1,000 - 10,000 |
| 5 | homework | 作业表 | 500 - 5,000 |
| 6 | questions | 题目表 | 2,000 - 20,000 |
| 7 | submissions | 提交表 | 10,000 - 100,000 |
| 8 | course_resources | 课程资源表 | 1,000 - 10,000 |
| 9 | learning_progress | 学习进度表 | 10,000 - 100,000 |
| 10 | notifications | 通知表 | 10,000 - 100,000 |
| 11 | audit_logs | 审计日志表 | 100,000 - 1,000,000 |
...
| 值 | 说明 | 存储内容 |
|----|------|---------|
| markdown | Markdown文档 | Markdown文本 |
| html | HTML文档 | HTML代码 |
| video | 视频 | 视频URL或路径 |
| pdf | PDF文档 | PDF文件URL或路径 |
| interactive | 交互式内容 | JSON配置 |
...
| 约束名 | 类型 | 说明 |
|--------|------|------|
| pk_lessons | 主键 | lesson_id 主键 |
| fk_lessons_course | 外键 | 关联到 courses 表 |
| chk_lessons_content_type | 检查 | content_type 必须是指定值之一 |
| chk_lessons_order | 检查 | order >= 0 |
