<template>
<div class="app-shell">
<TeacherNav active-tab="homework" />
...
.grade-summary {
  ...
  font-size:0.74rem;color:var(--accent);font-weight:600;margin-bottom:14px;
}
...
.finish-grade-btn:hover:not(:disabled) { box-shadow:0 6px 24px var(--accent-bright) !important; }
